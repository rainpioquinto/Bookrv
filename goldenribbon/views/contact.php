<?php include './includes/head.php';
  include './controller/submit-feedback.php';
?>
<body>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto">
                ...
                <li class="nav-item m-auto">
                    <a class="nav-link active" href="contact"><span class="sr-only">(current)</span>Contact</a>
                </li>
            </ul>
            ...
            <fieldset>
              ...
              <div class="form-group">
                <div class="col-md-12 text-right">
                  <button type="submit" name="send_btn" class="btn btn-primary"><i class="fa fa-send"></i> Send</button>
                </div>
              </div>
            </fieldset>
