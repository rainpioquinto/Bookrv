...
<body>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
          ...
          <ul class="navbar-nav m-auto">
            ...
            <li class="nav-item m-auto">
                <a class="nav-link active" href="admin-feedback">Feedbacks</a>
            </li>
  ...
  <div class="container-fluid" id="feedback-body" style="padding-top:30px">
  <h2 class="featurette-heading text-center">Feedback</h2>

<?php include './controller/display-comments.php'; ?>
</div>
